...
import Leaf1 from "/images/leaf (4).jpg"
  ...
  return (
    <section className="relative py-10 px-5 lg:px-20">
      <div className="container z-40">
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    experiments, and modeling, to study the complex
                    interactions.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Ecology is a crucial field that helps us understand the
        ...
        <div className="absolute hidden lg:block top-0 right-9">
          <img
            src={Leaf}
            alt="Leaf"
            className="w-32 transform rotate-360 z-0 leaf"
          />
        </div>
        <div className="absolute hidden lg:block right-60 top-0">
          <img src={Leaf1} alt="Leaf" className="leaf-one z-0 w-20" />
        </div>
      </div>
    </section>
  );
